...
### Changed
- **Metadata**: Updated extension display name to "FireGen - AI Media Generator" (3-5 words requirement).
- **Author**: Added author email to `extension.yaml` for publishing compliance.
- **Documentation**: Standardized Node.js runtime version to 20 across all docs.
- **License**: Fixed license references in README to consistently state Apache-2.0.
